...
`;
         ...
         * COVOITURAGE
         *
         * Pas de covoiturage le jour même.
         * ============================================================
         */
        ...
        if (btnProposer) {
            ...
            btnProposer.addEventListener(
                ...
                () => {
                    ...
                    console.log(
                        "Validation : proposer un covoiturage"
                    );
        ...
        if (btnDemander) {
            ...
            btnDemander.addEventListener(
                ...
                () => {
                    ...
                    console.log(
                        "Validation : recherche d'un covoiturage"
                    );
